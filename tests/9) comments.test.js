const { Comment, Publication, Company, MediaFile, Education, Experience, Post, User, Token } = require("../models");
...
const { DB_HOST, WRONG_TOKEN, USER_ID_COMMENTS_TEST } = process.env;
