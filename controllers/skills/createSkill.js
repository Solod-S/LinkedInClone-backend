...
const createSkill = async (req, res, next) => {
  ...
  await existingSkill.save();
   return res
    .status(200)
    .json({ status: "success", message: `The skill "${existingSkill.skill}" was created before`, data: { existingSkill } });
};
  ...
  res
    .status(201)
    .json({ status: "success", message: "Skill successfully created", data: { skill: newSkill } });
};
